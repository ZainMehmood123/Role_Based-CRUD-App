...
//       {showTable ? (
//         <>
//           <span className="section-icon">📊</span> Table View ({posts.length})
//         </>
//       ) : (
//         <>
//           <span className="section-icon">📚</span> Your Posts ({posts.length})
//         </>
//       )}
//     </h2>

//     <button
//       className={`toggle-view-btn ${showTable ? "table" : "card"}`}
